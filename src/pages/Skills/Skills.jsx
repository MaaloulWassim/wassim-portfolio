...
import DevTools from "../../components/SkillsWeb/DevTools";
import Programming from "../../components/SkillsWeb/Programming";
            ...
            <div className={classes.heropage_content_wrapper}>
              ...
              <div className={classes.heropage_message}>
                <motion.p
                  ...
                  exit="hide"
                >
                  These are the tools that I predominantly utilize in my work as a software and web developer.
                </motion.p>
              </div>
            </div>
            <motion.div
